...
# small->high big->low
SCAN_Y = 135         # num pixels from the top to start horiz scan
SCAN_HEIGHT = 20      # num pixels high to grab from horiz scan
COLOR_THRESHOLD_LOW  = (100, 50, 30)    # HSV dark yellow (opencv HSV hue value is 0..179, saturation and value are both 0..255)
# COLOR_THRESHOLD_LOW  = (26, 65, 24)    # HSV dark yellow (opencv HSV hue value is 0..179, saturation and value are both 0..255)
COLOR_THRESHOLD_HIGH = (179,150,150) # HSV light yellow (opencv HSV hue value is 0..179, saturation and value are both 0..255)
# # 
...
THROTTLE_MAX = 0.54    # maximum throttle value the controller will produce
THROTTLE_MIN = 0.46   # minimum throttle value the controller will produce
THROTTLE_INITIAL = THROTTLE_MIN  # initial throttle value
THROTTLE_STEP = 0.04  # how much to change throttle when off the line
# 
